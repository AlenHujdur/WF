...
namespace WindowsFormsApp1 {
    ...
    public partial class SalesDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerName, string CustomerStreet, string Region) {
            ...
            private void InitClass() {
                ...
                this.columnCustomerStreet.MaxLength = 30;
...
namespace WindowsFormsApp1.SalesDataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([CustomerId] = @Original_CustomerId) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_CustomerStreet = 1 AND [CustomerStreet] IS NULL) OR ([CustomerStreet] = @Original_CustomerStreet)) AND ((@IsNull_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_CustomerStreet", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerStreet", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CustomerStreet", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerStreet", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([CustomerName], [CustomerStreet], [Region]) VALUES" +
                " (@CustomerName, @CustomerStreet, @Region);\r\nSELECT CustomerId, CustomerName, Cu" +
                "stomerStreet, Region FROM Customers WHERE (CustomerId = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CustomerStreet", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerStreet", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustomerName] = @CustomerName, [CustomerStreet] = @CustomerStreet, [Region] = @Region WHERE (([CustomerId] = @Original_CustomerId) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_CustomerStreet = 1 AND [CustomerStreet] IS NULL) OR ([CustomerStreet] = @Original_CustomerStreet)) AND ((@IsNull_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)));
SELECT CustomerId, CustomerName, CustomerStreet, Region FROM Customers WHERE (CustomerId = @CustomerId)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CustomerStreet", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerStreet", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_CustomerStreet", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerStreet", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CustomerStreet", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerStreet", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, CustomerName, CustomerStreet, Region FROM dbo.Customers";
        ...
        public virtual int Fill(SalesDataSet1.CustomersDataTable dataTable) {
        ...
        public virtual SalesDataSet1.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SalesDataSet1.CustomersDataTable dataTable = new SalesDataSet1.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SalesDataSet1.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerId, string Original_CustomerName, string Original_CustomerStreet, string Original_Region) {
            ...
            if ((Original_CustomerStreet == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_CustomerStreet));
            }
        ...
        public virtual int Insert(string CustomerName, string CustomerStreet, string Region) {
            ...
            if ((CustomerStreet == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(CustomerStreet));
            }
            if ((Region == null)) {
        ...
        public virtual int Update(string CustomerName, string CustomerStreet, string Region, int Original_CustomerId, string Original_CustomerName, string Original_CustomerStreet, string Original_Region, int CustomerId) {
            if ((CustomerName == null)) {
            ...
            if ((CustomerStreet == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(CustomerStreet));
            }
            if ((Region == null)) {
            ...
            if ((Original_CustomerStreet == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_CustomerStreet));
            }
            if ((Original_Region == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerName, string CustomerStreet, string Region, int Original_CustomerId, string Original_CustomerName, string Original_CustomerStreet, string Original_Region) {
            return this.Update(CustomerName, CustomerStreet, Region, Original_CustomerId, Original_CustomerName, Original_CustomerStreet, Original_Region, Original_CustomerId);
        }
    }
